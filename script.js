...
function realizarPago() {
    ...
    var qrMessage = "Pago Exitoso,\nGracias por preferirnos.\n\nRioSmartPay";

    // Actualizar la imagen del código QR con el mensaje codificado
    document.getElementById("qr-img").src = "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=" + encodeURIComponent(qrMessage);
